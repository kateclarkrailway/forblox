...
@bot.tree.command(name="about", description="About Brxxks Blox", guild=GUILD)
async def cmd_about(interaction: discord.Interaction):
    embed = discord.Embed(
        title="🛡️ Brxxks Blox — About Us",
        color=0x2b2d31
    )
    embed.description = (
        "Brxxks Blox is a leading platform in the online gaming marketplace, providing a secure player-to-player trading "
...
async def cmd_scam(interaction: discord.Interaction):
    embed = discord.Embed(
        title="🛡️ Brxxks Blox | Scam Awareness Guide",
        color=0x2b2d31
    )
    embed.description = (
